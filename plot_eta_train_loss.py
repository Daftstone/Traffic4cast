...
pdf = PdfPages('data/eta_loss.pdf')
...
train_loss = np.load("data/eta_london_train_loss.npy")
test_loss = np.load("data/eta_london_val_loss.npy")
...
for i in range(50):
    for j in range(2):
        data = data.append({"Epochs": i+1, 'Loss': loss[j, i], 'Loss Type': method[j]},
                           ignore_index=True)
...
train_loss = np.load("data/eta_madrid_train_loss.npy")
test_loss = np.load("data/eta_madrid_val_loss.npy")
...
train_loss = np.load("data/eta_melbourne_train_loss.npy")
test_loss = np.load("data/eta_melbourne_val_loss.npy")
